jQuery(function($) {
    ...
    jQuery(document).on('click', '.paypal_for_edd_express_submit', function() {
        jQuery('.paypal_for_edd_express_submit_span').block({message: null});

    });
    jQuery(document).on('click', '.paypal_for_edd_express_cancel', function(e) {
        e.preventDefault();
        jQuery('.paypal_for_edd_express_cancel').block({message: null});
    ...
    jQuery(document).on('click', '#edd_purchase_form #edd_express_checkout_button', function(e) {
        ...
        jQuery('#edd_show_buttons').block({message: '<img src="' + base_url + 'public/images/paypal-loader.gif"/>', css: {}});
