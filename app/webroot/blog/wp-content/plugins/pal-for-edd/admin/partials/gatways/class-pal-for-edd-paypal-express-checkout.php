...
function show_full_shipping_details() {
    ...
    <fieldset id="edd_show_full_shipping_details" style="">
        <input id="form_action_url" type="hidden" value="<?php echo $formaction; ?>">
        <span><legend><?php echo __('Shipping Address', 'pal-for-edd'); ?></legend></span>
        <p><label ><?php echo $full_name; ?></label></p>
        <p><label ><?php echo $address1; ?></label></p>
        <p><label ><?php echo $address2; ?></label></p>
        <p><label ><?php echo $country_name; ?></label></p>
        <p>                
            <a class="button paypal_for_edd_express_cancel" href="<?php echo $cancle_url; ?>">Cancel Order</a>
